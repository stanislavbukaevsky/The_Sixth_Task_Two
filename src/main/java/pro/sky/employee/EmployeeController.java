...
public class EmployeeController {
    ...
    @GetMapping(path = "/add")
    public String addEmployee(@RequestParam("lastName") String lastName, @RequestParam("firstName") String firstName) throws EmployeeAlreadyAddedException {
    ...
    public String deleteEmployee(@RequestParam("lastName") String lastName, @RequestParam("firstName") String firstName) throws EmployeeNotFoundException {
        Employee employee = new Employee(lastName, firstName);
    ...
    public String toFindEmployee(@RequestParam("lastName") String lastName, @RequestParam("firstName") String firstName) throws EmployeeNotFoundException {
        Employee employee = new Employee(lastName, firstName);
